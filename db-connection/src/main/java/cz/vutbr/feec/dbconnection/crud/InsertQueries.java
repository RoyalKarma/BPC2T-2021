...
public class InsertQueries {
	 ...
	 * 
	 * POZN: není vhodné implementovat své metody tímto způsobem, daleko vhodnější
	 * je implementovat konkrétní metody (např. insertNewUser(String email, char[]
	...
	/**
	 * Úkol: Vaším úkolem je přiřadit INSERT příkaz do proměnné insertUser, tak aby
	 * se vytvořil nový uživatel dle zadaných parametrů
	 * 
	 * HINT: V této metodě jsou využity preparedStatements, takže se parametr emailu
	 * nastaví až později příkazem prStmt.setString(1, email)... Pro představu, jak
